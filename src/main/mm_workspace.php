            ...
            <div class="w3-container w3-padding-32 " id="container">
                ...
                <div class="w3-container" >
                    <div id="sendmsg" class="w3-container" >
                                ...
                                <?php      
                                    $sql="SELECT projects.PID, projects.PName, projects.Due_date, projects.Description, member.TID FROM projects INNER JOIN member ON member.PID=projects.PID WHERE member.MID='$id';";
                                    if($result=mysqli_query($conn, $sql)) {
                                        ...
                                        while($row=mysqli_fetch_array($result)) {
                                            ...
                                            echo '<td class="w3-center"> <form action="mm_workspace2.php" method="post">
                                                <input type="hidden" name="id" value="'.$id.'">
                                                <b><button class="w3-button w3-round" style="background-color: #0f2653; color: white;" name="tid" value="'.$row[4].'"  >Select</button></b>
                                                </form></td>';
                                            echo "</tr>";
                                        } 
                                        echo "</tbody></table><br>";
