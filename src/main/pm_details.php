...
<html>
    ...
    <body class="w3-content bdy" onload="display()">
            ...
            <div class="w3-bar-item"><b>
                <div class="btn2" style="margin-left: -15px;">
                    ...
                    <form action="pm_details.php" method="post">
						...
						<button class="w3-bar-item w3-button" style="color: #FFFFFF; background-color: #0F2653;">Project Details</button>
					</form>
        ...
        <div style="margin-top: 7%; margin-left: 20%;">
            ...
            <div id="projects" class="w3-content w3-padding " style="display:none;">
				...
				<?php      
					...
					if($result=mysqli_query($conn, $sql)) {
						...
						while($row=mysqli_fetch_array($result)) {
							...
							echo '<td class="w3-center"> <form action="pm_details.php" method="post">
            ...
            <div id="teams" class="w3-container " style="display:none">
				<div class="w3-container w3-border" id="container">
				...
				<?php      
					...
					if($result=mysqli_query($conn, $sql)) {
						...
						echo "</tbody></table>";
						echo '<div class="w3-center"><form action="pm_details.php" method="post">
								<input type="hidden" name="id" value="'.$id.'">
								<input type="hidden" name="pid" value="NULL">
								<input type="hidden" name="tid" value="NULL">
								<br><input class="w3-button w3-round w3-red" type="submit" value="Back"></form></div><br>';
					}
				?>
				</div>
			</div>
            <div id="members" class="w3-container " style="display:none">
				<div class="w3-container w3-border" id="container">
				<h2 class="w3-border-bottom w3-border-light-grey w3-padding-16 w3-center"><b>Member Details</b></h2>
				<?php      
					$sql="SELECT member.MID,member.Name,member.Designation,member.DOB, member.contact, accounts.Username FROM member JOIN accounts ON member.MID=accounts.MID WHERE member.TID = '$tid' ORDER BY member.Designation DESC;";
					if($result=mysqli_query($conn, $sql)) {
						echo "<table class='w3-table w3-striped'>";
						echo "<thead>";
						echo "<tr class='w3-light-grey'>";
                        ...
                        echo "<th class='w3-center'>Username</th>";
						echo "</tr>";
						echo "</thead>";
						echo "<tbody>";
						while($row=mysqli_fetch_array($result)) {
						...
						echo '<div class="w3-center"><form action="pm_details.php" method="post">
								<input type="hidden" name="pid" value="'.$pid.'">
								<input type="hidden" name="id" value="'.$id.'">
								<input type="hidden" name="tid" value="NULL"><br><input class="w3-button w3-red w3-round" type="submit" value="Back"></form></div><br>';
					}
				?>
				</div>
			</div>
