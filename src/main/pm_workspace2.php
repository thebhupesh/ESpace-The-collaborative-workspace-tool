...
<html>
    ...
    <body class="w3-content bdy" >
		...
		<div id="project" class="w3-content w3-padding pm_project" style="width: 80%; margin-left: 1%;">	
            <div class="w3-container w3-padding-32 " id="container" style="width: 80%; height: 5%; margin-left: 5%;">
                ...
                <div class="w3-container" >
                    <div id="prog_workspace" class="w3-container w3-border tabs" style="width: 120%; margin-left: -10%;"> 
                        <div id="prog1">
							    ...
							    if($result=mysqli_query($conn, $sql)) {
                                    ...
                                    while($row=mysqli_fetch_array($result)) {
                                        ...
                                        echo '<td class="w3-center"> 
                                            <b><button class="w3-bar-item w3-button w3-round" style="background-color: #0f2653; color: white;" name="wid" value="'.$row["WID"].'" onclick="update2(this.value)" >Select</button></b></td>';
                                        echo "</tr>";
                                    }
                                    echo "</tbody></table><br>";
                                }
