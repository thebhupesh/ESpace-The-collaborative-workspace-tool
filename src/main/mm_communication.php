                    ...
                    <div id="selectpid" class="w3-container w3-border tabs">
                        <div class="w3-center">
                            <div id="sendmsg" class="w3-container" >
                                ...
                                <?php      
                                    $sql="SELECT projects.PID, projects.PName, projects.Due_date, projects.Description FROM projects INNER JOIN member ON member.PID=projects.PID WHERE member.MID='$id';";
                                    if($result=mysqli_query($conn, $sql)) {
                                        ...
                                        while($row=mysqli_fetch_array($result)) {
                                            ...
                                            echo '<td class="w3-center"> <form action="mm_communication2.php" method="post">
