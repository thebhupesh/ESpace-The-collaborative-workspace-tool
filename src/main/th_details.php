            ...
            <div class="w3-bar-item"><b>
                <div class="btn2" style="margin-left: -15px">
                    <form action="th_details.php" method="post">
						...
						<button class="w3-bar-item w3-button" style="color: #FFFFFF; background-color: #0F2653;">View Team Details</button>
					</form>
                    <form action="th_teammember.php" method="post">
						<?php echo "<input type='hidden' name='id' value='$id'>"; ?>
						<button class="w3-bar-item w3-button w3-light-grey frame"
                        >Team Members</button>
					</form>
