...
<html>
    ...
    <body class="w3-content bdy">
		...
		<div class="help" style="text-align: center; width: 80%;">
            ...
            Select "Workspace" on the side panel -> Select Project from the list -> Select the Workspace from the list -> <br>Workspace Environment displayed with Formatting Tools
            </p>
            ...
            Select "Communication" on the side panel -> Select Project from the list -> <br>Select "Project Channel" for Project Messages or "Team Channel" for Team Messages
            </p>
